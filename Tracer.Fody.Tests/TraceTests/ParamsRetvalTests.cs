...
{
    [TestFixture]
    public class ParamsRetvalTests : TestBase
    {
        [Test]
        ...
        public void Test_Generic_Class_Method()
        {
            ...
            result.ElementAt(2).ShouldBeTraceEnterInto("First.MyGenClass<Int32>::CallMe", "param", "Hello", "paramT", "42");
            result.ElementAt(3).ShouldBeTraceLeaveFrom("First.MyGenClass<Int32>::CallMe", "0");
        }
    }
}
